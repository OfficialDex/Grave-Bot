# Grave
Grave is a free and open source multipurpose discord bot written in python using discord.py library by [Blaze](https://discord.com/users/1238444724386533417) and [Iak](https://discord.com/users/1227208557271846983). It consists of over 85+ commands (excluding extension based)
...
Read [docs](extension.md)
And after completing, send PR and we will review as soon as we could
...
- Fixed some commands
- Fixed imports
Converted left over commands into embed
- Added 2 extensions
...
# Notice
**This is the fork of [original repository](https://github.com/imiakk/GraveBot), project leader aka [iak](https://discord.com/users/1227208557271846983) have discontinued working on this project hence I, [blaze](https://discord.com/users/1238444724386533417) have decided to continue its legacy myself and provide ocassional updates to it**
